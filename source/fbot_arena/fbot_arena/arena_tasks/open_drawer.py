...
class OpenDrawerTask(TaskBase):
    def __init__(
        ...
        self.events_cfg = OpenDrawerEventCfg(self.openable_object, reset_openness=self.reset_openness)
    ...
    def get_prompt(self):
        return f"open the {self.openable_object.name} drawer"

    def get_mimic_env_cfg(self, embodiment_name: str):
        return OpenDrawerMimicEnvCfg(
...
@configclass
class OpenDrawerEventCfg:
    """Configuration for Open Door."""

    reset_drawer_state: EventTermCfg = MISSING
    ...
    def __init__(self, openable_object: Openable, reset_openness: float | None):
        ...
        self.reset_drawer_state = EventTermCfg(
        ...
        if initial_pose is not None:
            ...
            self.randomize_openable_object_pose = None


@configclass
class OpenDrawerMimicEnvCfg(MimicEnvCfg):
    """
    Isaac Lab Mimic environment config class for Open Door env.
    """

    embodiment_name: str = "xarm6"
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "demo_src_opendrawer_isaac_lab_task_D0"
        ...
        subtask_configs.append(
            SubTaskConfig(
                ...
                subtask_term_signal="move_to_drawer",
        ...
        elif self.embodiment_name in ("franka", "xarm6"):
            self.subtask_configs["robot"] = subtask_configs
