...
class BimanualOpenArmPickExhaustPipeEnvironment(ExampleEnvironmentBase):
    ...
    def get_env(self, args_cli):
        ...
        table = ObjectReference(
            name="table",
            prim_path="{ENV_REGEX_NS}/packing_table/SM_CratePacking_Table_A1/SM_HeavyDutyPackingTable_C02_01/Geometry",#/container_h20_inst/Container_H20_01
        ...
        scene = Scene(assets=[background, exhaust_pipe, table])
